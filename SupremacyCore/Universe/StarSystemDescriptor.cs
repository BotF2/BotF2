...
namespace Supremacy.Universe
{
    ...
    //  loading from Resources/Data/Wormhole.xml doesn't make sense until we don't place additional wormholes e.g. nearby Bajor

    //[Serializable]
    //public class WormholeDatabase : Dictionary<string, StarSystemDescriptor>
    //{
    //    private const string XmlFilePath = "Resources/Data/Wormhole.xml";
    ...
    //    public static WormholeDatabase Load()
    //    {
    //        XmlSchemaSet schemas = new XmlSchemaSet();
    //        WormholeDatabase db = new WormholeDatabase();
    //        XmlDocument xmlDoc = new XmlDocument();
    ...
    //        foreach (XmlElement wormholeElement in xmlRoot.GetElementsByTagName("Wormhole"))
    //        {
    //            //string civId = wormholeElement.GetAttribute("Civilization").Trim().ToUpperInvariant();
    //            //db[civId] = new StarSystemDescriptor(wormholeElement["StarSystem"]);
    //            //GameLog.Client.GameData.DebugFormat("Wormhole.xml-civId={0}", civId);
    //        }
    ...
    //        {
    //            XmlDocument xmlDoc = new XmlDocument();
    //            XmlElement rootElement = xmlDoc.CreateElement("Wormhole");
    ...
    //            //{
    //            //    XmlElement wormholeElement = xmlDoc.CreateElement("Wormhole");
    //            //    wormholeElement.SetAttribute("Civilization", civId);
    //            //    this[civId].AppendXml(wormholeElement);
    //            //    rootElement.AppendChild(wormholeElement);
    //            //}
