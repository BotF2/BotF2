...
namespace Supremacy.Universe
{
    public static class GalaxyGenerator
    {
            ...
            out Collections.CollectionBase<MapLocation> homeLocations)
        {
            ...
            bool result = PlaceEmpireHomeworlds(positions, starNames, homeSystemDatabase, empires,
                 homeLocations, chosenCivs, GameContext.Current.Options.GalaxyCanon == GalaxyCanon.Canon);
