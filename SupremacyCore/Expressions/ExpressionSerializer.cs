...
namespace Supremacy.Expressions.Serialization
{
    public class ExpressionSerializer
    {
        ...
        {
            resolver = new ExpressionSerializationTypeResolver();
            Converters = new List<CustomExpressionXmlConverter>();
        }
        ...
        private XElement GenerateXmlFromExpressionCore(Expression e)
        {
            ...
            return new XElement(
                ...
                let value = prop.GetValue(e, null)
                where value != null
                select GenerateXmlFromProperty(prop.PropertyType, prop.Name, value));
        }
        ...
        private static Expression Reduce(Expression e)
        {
            ...
            if (memberExpression != null)
            {
                ...
                if ((constantExpression != null) &&
                    Attribute.IsDefined(constantExpression.Type, typeof(CompilerGeneratedAttribute)))
                {
                    var fieldInfo = memberExpression.Member as FieldInfo;
                    if ((fieldInfo != null) && (fieldInfo.FieldType.IsValueType || (fieldInfo.FieldType == typeof(string))))
        ...
        private Expression ParseMemberExpressionFromXml(XElement xml)
        {
            ...
            if (xml.Element("Expression") != null)
                expression = ParseExpressionFromXml(xml.Element("Expression"));
