...
namespace Supremacy.AI
{
    public static class ColonyAI
    {
        ...
        public static void DoTurn([NotNull] Civilization _civ)
        {
            ...
            string _text = _newline + "Step_1101:; ColonyAI.DoTurn begins... for > " + _civ.Key
            ...
            foreach (Colony colony in GameContext.Current.Universe.FindOwned<Colony>(_civ.CivID))
            {
                ...
                try
                {
                    ...
                    //string _net_industry_text = GameEngine.Do_4_Digit(colony.NetIndustry.ToString());
                    ...
                    colony.ProcessQueue();
                    Check_Population(colony);  // + Handle_Energy_Production(_colony); // done inside Check_Population
                    ...
                    if (colony.BuildQueue.Count < 3)  // ColonyAI ..foreach _colony
                    {
                        ...
                        if (_colonyAIControlled)  // not for human player
                        {
                            ...
                            Build_for_LaborPool(colony, _civ); // this first > if free labors, build facilities (no new upgrades!)
                            Handle_Upgrades(colony, _civ);
                            Handle_Basic_Structures(colony, _civ); // older code > Bunker Network, Extractors etc.
                            Handle_Buildings(colony, _civ);
                            Handle_Additional_Structures(colony, _civ);
                            CheckFor_All_Build_Projects(colony);

                            Handle_Flex_Production(colony, _civ); // older code
                            Handle_Build_Anything(colony, _civ);
                        }
        ...
        {
            string _newline = Environment.NewLine;
            string _text = /*_newline + */"Step_1218:; " + GameEngine.LocationString(colony.Location.ToString())
                    + " > " + _name_col + " ; " + _owner_col
                    + " > Check for Handle_Flex_Production (older code): "
                    + ", BuildQueue.Count= " + colony.BuildQueue.Count
                    + ", _colony.AvailableLabor= " + colony.AvailableLabor
                    ;
            if (writeDirectly_Colony) Console.WriteLine(_text);
            _colony_full_Report += _newline + _text;
            ...
            if (/*_colony.BuildSlots.All(t => t.Project == null) && */colony.BuildQueue.Count < 2)
            {
                ...
                int flexLabors = colony.GetAvailableLabor() - 30; // flexProduction.Sum(c => _colony.GetFacilityType(c).LaborCost * _colony.GetActiveFacilities(c));
                if (flexLabors > -21)  // 2 more facilites as available labors, 10 labors = 1 facility
                {
                    ...
                    else
                    {
                        ...
                        _text = "Step_1244:; " + GameEngine.LocationString(colony.Location.ToString())
                            + " > Handle_Flex_Production on "
                                + _name_col + ", Owner= " + _owner_col
                        ...
                        if (colony.GetTotalFacilities(ProductionCategory.Intelligence) + 1 < (colony.GetTotalFacilities(ProductionCategory.Research) + 2) / 2)
                        {
                            ...
                            _text = "Step_1245:; " + GameEngine.LocationString(colony.Location.ToString())
                                + " > Handle_Flex_Production on "
                                    + _name_col + ", Owner= " + _owner_col
        ...
        private static void CheckFor_All_Build_Projects(Colony colony)
        {
            ...
            //{
            //    CheckFor_Food_Facility(_colony, _available_item, _available_item_Category);
            //}
            ...
            //{
            //    CheckFor_Industry_Facility(_colony, _available_item, _available_item_Category);
            ...
            //{
            //    CheckFor_Research_Facility(_colony, _available_item, _available_item_Category);
            //    //_text = "Step_1424:; " + GameEngine.LocationString(_colony.Location.ToString()) /*+ " Check for Research on; "*/
            //    //         + " > " + _name_col + " ; " + _owner_col
            //    //         + " >  Check for Research > "
            //    //         + "current " + _colony.Facilities_Total4_Research
            //    //         + ", calc by maxPop= " + _colony.Population_Max / 50
            //    //         ;

            //    //if (writeDirectly_Colony) Console.WriteLine(_text);
            //    //_colony_full_Report += _newline + _text;

            //    //if (_colony.Facilities_Total4_Research < _colony.Population_Max / 50) // each 50 pop = 1 research = 20%
            //    //{
            //    //    _itemToBuild_Facility = _available_item;
            //    //}
            //    //else
            ...
            //    //    _text = "Step_1434:; " + GameEngine.LocationString(_colony.Location.ToString()) /*+ " Check for Food on; "*/
            //    //        + " > " + _name_col + " ; " + _owner_col
            //    //        + " >  Check for Research > "
            //    //        + "current " + _colony.Facilities_Total4_Research
            //    //        + ", calc by maxPop= " + _colony.Population_Max / 100
            ...
            //{
            //    CheckFor_Intelligence_Facility(_colony, _available_item, _available_item_Category);
            ...
            //    //if (_colony.Facilities_Total5_Intelligence < _colony.Population_Max / 100) // each 100 pop = 1 intel = 10%
            //    //{
            //    //    _itemToBuild_Facility = _available_item;
            //    //}
            //    //else
            ...
            //    //    _text = "Step_1435:; " + GameEngine.LocationString(_colony.Location.ToString()) /*+ " Check for Food on; "*/
            //    //            + " > " + _name_col + " ; " + _owner_col
            //    //            + " >  Check for Intelligence > "
            //    //            + "current " + _colony.Facilities_Total5_Intelligence
            //    //            + ", calc by maxPop= " + _colony.Population_Max / 100
            ...
            SkipFacilities_1:
                ...
                if (/*_itemToBuild_Facility == null && */_available_item.BuildDesign.Key.Contains("Battery"))
                {
                    ...
                    if (colony.OrbitalBatteries_Total < GameContext.Current.TurnNumber / 8 && colony.OrbitalBatteries_Total < 49)
                    {
                        _itemToBuild_Facility = _available_item;
        ...
        {
            CivilizationManager _civM = GameContext.Current.CivilizationManagers[colony.Owner];
            ...
            if (checkForShipProduction && colony.Owner.IsHuman)
            {
                //Debugger.Break();
            }


            if (colony.Shipyard.BuildSlots != null && !PlayerAI.IsInFinancialTrouble_BelowMinus2000(colony.Owner))
            {
            ...
            else
            {
                ...
                if (writeDirectly_Colony) Console.WriteLine("Step_1426:; " + _text);
        ...
        {
            if (colony.Owner.IsHuman /*&& _colony.Name == "Sol"*/)
            {
                //Debugger.Break();
            }
            string _newline = Environment.NewLine;
            ...
            if (colony.Facilities_Total5_Intelligence /*+ 1*/ > _intelligencePerPop) // x over calc is ok
            {
                ...
                if (colony.Facilities_Total5_Intelligence - 1 > _intelligencePerPop)
                {
                    colony.RemoveFacility(ProductionCategory.Intelligence);
        ...
        private static void CheckFor_Research_Facility(Colony colony, BuildProject available_item, ProductionCategory available_item_Category)
        {
            ...
            _text = "Step_1464:; " + GameEngine.LocationString(colony.Location.ToString()) /*+ " Check for Research on; "*/
                     + " > " + _name_col + " ; " + _owner_col
                     + " >  Check for Research > "
            ...
            if (colony.Facilities_Total4_Research - 1 < _researchCalc) // each 50 pop = 1 research = 20%
            {
                _itemToBuild_Facility = available_item;
            }
        ...
        private static void Print_Colony_Owner_IsHuman(Colony colony)
        {
            _colonyAIControlled = true;
            string _text;
            _text = /*_newline +*/ "Step_1102:; " + GameEngine.LocationString(colony.Location.ToString()) + " *** " + _name_col + " " + _owner_col
                + " * > AIcontrolled= " + _colonyAIControlled // + " ) > Handling _colony"
                + "; BuildQueue.Count= " + colony.BuildQueue.Count // + " ) > Handling _colony"
                                                                   //+ " Energy > Food > B_Structures > Buildings > Add_Str > Upgrades > BuildQueues "
                ;
            if (writeDirectly_Colony) Console.WriteLine(_text);
        ...
        private static void CheckFor_Industry_Facility(Colony _colony, BuildProject _available_item, ProductionCategory _available_item_Category)
        {
            string _newline = Environment.NewLine;
            string _text;
            //ProductionCategory.Industry
            ...
            _text = "Step_1422:; " + GameEngine.LocationString(_colony.Location.ToString()) /*+ " Check for Food on; "*/
                 ...
                 + ", calc by maxPop= (max) " + _colony.Population_Max / 20
                 ;
            ...
            if (_colony.Facilities_Total2_Industry + 1 < _colony.Population_Max / 20) // each 20 pop = 1 industry = 50%
            {
                _itemToBuild_Facility = _available_item;
            }
            else
        ...
        private static void CheckFor_Food_Facility(Colony colony, BuildProject available_item, ProductionCategory available_item_Category)
        {
            //try
            //{
            string _text = "Step_1421:; " + GameEngine.LocationString(colony.Location.ToString()) /*+ " Check for Food on; "*/
                     + " > " + _name_col + " ; " + _owner_col
                     + " >  Check for Food > "
                              + "current _colony.NetFood= " + colony.NetFood
        ...
        private static void Build_Queue_Clean(Colony colony)
        {
            ...
            for (int i = 0; i < _total; i++)
            {
                ...
                _text = "Step_1431:; " + GameEngine.LocationString(colony.Location.ToString())
                    + " > " + _name_col + " ; " + _owner_col
                    + " > BuildQueue of " + _total + " > # " + i + " > " + colony.BuildQueue[i].Description
                    //+ " > BuildQueue # " + i + " > " + _colony.BuildQueue[i].Description
                    + " (Build_Queue_Clean) "
        ...
        private static void Print_all_Build_Projects(IList<BuildProject> all_Build_Projects)
        {
            ...
            //if (writeDirectly_Colony) Console.WriteLine("# Begin of _all_Build_Projects_Text" /*+ _newline */
        ...
        private static void Check_Population(Colony colony)
        {
            ...
            //_text = "Step_2345:; " + GameEngine.LocationString(GameEngine.LocationString(_colony.Location.ToString()).ToString())
            ...
            // works
            //_text = "Step_2347:; " + GameEngine.LocationString(_colony.Location.ToString()) + " All-De-Activated !!, Pop= " + _popAvailable
            //        + ", Active: Food= " + _colony.GetActiveFacilities(ProductionCategory.Food)
            //        + ", Ind= " + _colony.GetActiveFacilities(ProductionCategory.Industry)
            //        + ", En= " + _colony.GetActiveFacilities(ProductionCategory.Energy)
            //        + ", Res= " + _colony.GetActiveFacilities(ProductionCategory.Research)
            ...
            //{
            //    _colony.DeactivateFacility(ProductionCategory.Energy);
            //    _popAvailable += 1;
            //}
            ...
            //{
            //    _colony.ActivateFacility(ProductionCategory.Energy);
            //    _popAvailable -= 1;
            //}
        ...
        private static void Handle_Energy_Production(Colony _colony)
        {
            ...
            while (_colony.DeactivateFacility(ProductionCategory.Industry)) { } // take it from industry and...

            while (_colony.ActivateFacility(ProductionCategory.Energy)) { } // turn on all energy facilities

            // next_Check / set Breakpoint
            // turn things on
            foreach (Buildings.Building building in _offlineBuilding)
            {
                _ = _colony.ActivateBuilding(building);
            }

            foreach (ShipyardBuildSlot slot in _offlineShipyardSlots)
            {
                _ = _colony.ActivateShipyardBuildSlot(slot);
            }
                ...
                || (_colony.Shipyard?.BuildSlots.Any(s => !s.IsActive) == true)) && !_colony.IsBuilding(facilityType))
            {
                ...
                _text = "Step_1248:; " + GameEngine.LocationString(_colony.Location.ToString()) + " > " + _name_col + " ; " + _owner_col + " > Handle ENERGY "
            ...
            if (_colony.NetEnergy - (int)_energyOutput > 20)  // later another one is added if possible
            {
                _colony.DeactivateFacility(ProductionCategory.Energy);
                //_popAvailable += 1;
            }
        ...
        private static void Handle_Food_Production(Colony colony)
        {
            ...
            if (colony.NetFood < 15 && colony.FoodReserves.CurrentValue + 1 / colony.Population.CurrentValue + 1 < 5 && !colony.IsBuilding(facilityType))
            {
                ...
                _text = "Step_1228:; " + GameEngine.LocationString(colony.Location.ToString()) + " > " + _name_col + " " + _owner_col + " > Handle_FOOD_Production "
        ...
        private static void Handle_Industry_Production(Colony colony)
        {
            ...
            int maxProdFacility = Math.Min(colony.TotalFacilities[ProductionCategory.Industry].Value,
                (colony.GetAvailableLabor() / colony.GetFacilityType(ProductionCategory.Industry).LaborCost)
                + colony.ActiveFacilities[ProductionCategory.Intelligence].Value
                + colony.ActiveFacilities[ProductionCategory.Research].Value
        ...
        private static void Handle_Food_Labors_UNDONE(Colony colony)
        {
        }

        private static void Handle_Labors_for_Nothing_to_Build(Colony colony)
        {
            ...
            //if (!colony.BuildSlots[0].HasProject)  // at Buy=Rush BuildSlot always has a project
            ...
            colony.ActivateFacility(ProductionCategory.Industry); // Activate at least one industry (e.g. new colony)

            colony.ActivateFacility(ProductionCategory.Research); // Activate up to 2 Research
            colony.ActivateFacility(ProductionCategory.Research); // Activate up to 2 Research

            colony.ActivateFacility(ProductionCategory.Intelligence); // Activate up to 2 Intelligence
            colony.ActivateFacility(ProductionCategory.Intelligence); // Activate up to 2 Intelligence

            while (colony.ActivateFacility(ProductionCategory.Industry)) { } // Activate all industry

            colony.DeactivateFacility(ProductionCategory.Industry); // Deactivate 2 Industry
            //colony.DeactivateFacility(ProductionCategory.Industry); // Deactivate 2 Industry
            //colony.DeactivateFacility(ProductionCategory.Industry); // Deactivate 2 Industry
            ...
            while (colony.ActivateFacility(ProductionCategory.Research)) { } // Activate all 
            while (colony.ActivateFacility(ProductionCategory.Intelligence)) { } // Activate all 
            while (colony.ActivateFacility(ProductionCategory.Industry)) { } // Activate all industry
        ...
        private static void Handle_Buildings(Colony colony, Civilization civ)
        {
            ...
            if (/*_colony.BuildSlots.All(t => t.Project == null) &&*/ colony.BuildQueue.Count < 2)
            {
                _text = "Step_1202:; " + GameEngine.LocationString(colony.Location.ToString())
                    + " > " + colony.Name
                    + " > Handle_Buildings: "
                ...
                if (colony.BuildSlots.All(t => t.Project == null) && colony.BuildQueue.Count < 2)
                {
                    ...
                    {
                        _text = "Step_1216:; " + GameEngine.LocationString(colony.Location.ToString()) + " > "
                                + _name_col + " > " + _owner_col
                                + " > Handle_Buildings on  > no Upgrade INDUSTRY"
                                ;
                        if (writeDirectly_Colony) Console.WriteLine(_text);
                        _colony_full_Report += _newline + _text;
                    }
            ...
            if (colony.BuildSlots.All(t => t.Project == null) && colony.BuildQueue.Count < 2)
            {
                ...
                {
                    _text = "Step_1211:; " + GameEngine.LocationString(colony.Location.ToString())
        ...
        private static void Handle_Basic_Structures(Colony colony, Civilization civ)
        {
            string _newline = Environment.NewLine;
            string _text;
            _text = "Step_1231:; " + GameEngine.LocationString(colony.Location.ToString())
                    + " > " + _name_col + " ; " + _owner_col
                    + " > Handle_Basic_Structures > BuildQueue.Count= " + colony.BuildQueue.Count
                    ;
            if (writeDirectly_Colony) Console.WriteLine(_text);
            ...
            if (colony.BuildQueue.Count > 0)
            {
                _text = "Step_1234:; " + GameEngine.LocationString(colony.Location.ToString())
                    + " > " + _name_col + " ; " + _owner_col
                        + " > Handle_Basic_Structures > already building >; " + colony.BuildQueue[0].Description;
                ;
                if (writeDirectly_Colony) Console.WriteLine(_text);
                _colony_full_Report += /*_newline + */_text;
            }
            ...
            if (colony.BuildQueue.Count < 2) // Handle_Basic_Structures
            {
                ...
                // no needed
                //_text = "Step_1232:; " + GameEngine.LocationString(_colony.Location.ToString()) + " Handle_Basic_Structures"
                //    + " on; " + _name_col
                //    + "; " + _owner_col
                //    + "; Morale=; " + _colony.Morale
                ...
                //{
                //    _text = "Step_1249:; " + GameEngine.LocationString(_colony.Location.ToString()) + " Handle_Basic_Structures"
                //            + " on; " + _name_col
                //            + "; " + _owner_col
                ...
                //_text = "Step_1236:; " + GameEngine.LocationString(_colony.Location.ToString()) + " Handle_Basic_Structures"
                //            + " on; " + _name_col
                //            + "; " + _owner_col
                //            + "; Morale=; " + _colony.Morale
                ...
                _text = "Step_1258:; " + GameEngine.LocationString(colony.Location.ToString()) //+ " > Handle_Basic_Structures"
                        + " > " + _name_col
                        + " ; " + _owner_col
                ...
                {
                    colony.BuildQueue.Add(new BuildQueueItem(structureProject));
                    _text = "Step_1269:; " + GameEngine.LocationString(colony.Location.ToString())
                            + " > " + _name_col
                            + " ; " + _owner_col
                            + "; Morale=; " + colony.Morale
                            + "; prodOutput=;" + prodOutput
        ...
        private static void Build_for_LaborPool(Colony colony, Civilization civ)
        {
            ...
            //{
            //    _text = "Step_1234:; " + GameEngine.LocationString(_colony.Location.ToString()) + " > Build_for_LaborPool on; "
            //            + _name_col + " ; " + _owner_col
        ...
        private static void Handle_Additional_Structures(Colony colony, Civilization civ)  // unneccesary but still in
        {
            ...
            if (/*_colony.BuildSlots.All(t => t.Project == null) && */colony.BuildQueue.Count < 2) // Handle_Additional_Structure
            {
                _text = "Step_1249:; " + GameEngine.LocationString(colony.Location.ToString())
                        + " > " + _name_col + " ; " + _owner_col
                ...
                if (/*_colony.BuildSlots.All(t => t.Project == null) && */colony.BuildQueue.Count < 2) // Handle_Additional_Structures
                {
                    double prodOutput = colony.GetFacilityType(ProductionCategory.Industry).UnitOutput
                        * colony.Morale.CurrentValue / (0.5f * MoraleHelper.MaxValue)
                        * (1.0 + colony.GetProductionModifier(ProductionCategory.Industry).Efficiency);
                    ...
                    {
                        colony.BuildQueue.Add(new BuildQueueItem(structureProject));
                        _text = /*_newline + */"Step_1297:; " + GameEngine.LocationString(colony.Location.ToString())
                                + " > " + _name_col + " " + _owner_col
                            + " Added= " + structureProject.BuildDesign

                                + " > by using ** Handle_Additional_Structures ** " /*+ _colony.BuildQueue.Count*/
                                ;
                        if (writeDirectly_Colony) Console.WriteLine(_text);
                        _colony_full_Report += _newline + _text;
                    }
        ...
        private static void Handle_Upgrades(Colony colony, Civilization civ)
        {
            string _newline = Environment.NewLine;
            string _text;
            _text = /*_newline + */"Step_1207:; " + GameEngine.LocationString(colony.Location.ToString())
                    + " > " + _name_col + " ; " + _owner_col
            ...
            if (colony.BuildQueue.Count < 1 && colony.AvailableLabor < 1)
            {
                try
                {
                    ...
                    ProductionFacilityUpgradeProject upgradeIndustryProject = TechTreeHelper
                        .GetBuildProjects(colony)
                        .OfType<ProductionFacilityUpgradeProject>()
                        .FirstOrDefault(bp => bp.IsUpgrade
                    ...
                    upgradeIndustryProject = TechTreeHelper
                        .GetBuildProjects(colony)
                        .OfType<ProductionFacilityUpgradeProject>()
                        //.Where(o => o.IsUpgrade)
                        .FirstOrDefault();
        ...
        private static void Handle_Build_Anything(Colony colony, Civilization civ)
        {
            string _newline = Environment.NewLine;
            string _text;
            _text = "Step_1261:; " + GameEngine.LocationString(colony.Location.ToString())
                + " > " + _name_col + " ; " + _owner_col
            ...
            //    //_text = "Step_1234:; " + GameEngine.LocationString(_colony.Location.ToString()) + "; " + _name_col + " ; " + _owner_col + " Handle_Build_Anything on; "
            ...
            if (colony.BuildQueue.Count < 2) //Handle_Build_Anything
            {
                ...
                //foreach (var item in availableResources)
                //{
                //    _text = "Step_1255:; " + GameEngine.LocationString(_colony.Location.ToString()) + " Handle_Build_Anything"
                //            + " on; " + _name_col
                //            + "; " + _owner_col
                ...
                OrbitalBatteryBuildProject obProject = TechTreeHelper.GetBuildProjects(colony)
                ...
                //    _text = "Step_1233:; " + GameEngine.LocationString(_colony.Location.ToString()) + " Handle_Basic_Structures"
                //                + " on; " + _name_col
                //                + "; " + _owner_col
                //                + "; Morale=; " + _colony.Morale
                //                //+ "; prodOutput=;" + prodOutput // per unit
                ...
                if (obProject != null)
                {
                    ...
                    if (/*_itemToBuild_Facility == null && */obProject.BuildDesign.Key.Contains("BATTERY"))
                    {
                        ...
                        if (colony.OrbitalBatteries_Total < GameContext.Current.TurnNumber / 6)
                        {
                    ...
                    && _itemToBuild.BuildDesign.EncyclopediaCategory == Encyclopedia.EncyclopediaCategory.Facilites)
                {
                    ...
                    {
                        case ProductionCategory.Industry:
                            CheckFor_Industry_Facility(colony, _itemToBuild, ProductionCategory.Industry);
                            break;
                        case ProductionCategory.Research:
                            CheckFor_Research_Facility(colony, _itemToBuild, ProductionCategory.Research);
                            break;
                        case ProductionCategory.Intelligence:
                            CheckFor_Intelligence_Facility(colony, _itemToBuild, ProductionCategory.Intelligence);
                            break;
                        case ProductionCategory.Food:
                            CheckFor_Food_Facility(colony, _itemToBuild, ProductionCategory.Food);
                            break;
                    }
        ...
        private static void Handle_Buy_Build(Colony colony, Civilization civ)
        {
            ...
            colony.BuildSlots.Where(s => s.Project?.IsRushed == false).ToList().ForEach(s =>
            {
                ...
                int cost = s.Project.GetTotalCreditsCost();  // we take max half of the credits

                //if ((_civM.Credits.CurrentValue - (cost * 0.2)) > s.Project.GetTotalCreditsCost())
                if ((_civM.Credits.CurrentValue > cost * 2 && _civM.Credits.CurrentValue > 1000))
                {
                    ...
                    if (cost < _civM.Credits.CurrentValue / 4 && turnsNeeded > 4)
                    {
                        _buyQuick = true;
                    }
                    ...
                    if (_buyQuick == true || turnsNeeded > 1 && turnsNeeded < 3 || cost < 600)  // we buy when turnsNeede = 2 or cost less than 600
                    {
                        ...
                        //while (_colony.DeactivateFacility(ProductionCategory.Industry)) { }  ??
                    }
                }
            });
            Handle_Labors_for_Nothing_to_Build(colony);
        ...
        private static void Handle_Ship_Production(Colony colony, Civilization civ) //, Dictionary<ShipType, Tuple<int, string>> _listPrioShipBuild)
        {
            ...
            string _newline = Environment.NewLine;
            string _text = /*_newline + */"Step_5780:; " + GameEngine.LocationString(colony.Location.ToString()) + " ShipProduction > " + _name_col;
            //if (writeDirectly_Colony) Console.WriteLine(_text);
            //_colony_full_Report += _newline + _text;


            if (PlayerAI.IsInFinancialTrouble_BelowMinus2000(colony.Owner) && colony.Owner.Key != "BORG")
            {
                _text = "Step_5783:; "
            ...
            IList<BuildProject> projects = potentialProjects; // projects identical with potentialProjects
            ...
            {
                _text = "Step_1213:; " + GameEngine.LocationString(colony.Location.ToString()) + " Handle_Ship_Production: "
            ...
            foreach (BuildProject _proj in projects)
            {
                ...
                // Ship production
                //potentialProjects.Add(_proj); - this is already populated
                ...
                if (GameContext.Current.TurnNumber < 14 && colony.Owner.Key == "BORG")
                {
                    _neededShipType = ShipType.Construction;
                    _neededShipTypeText = "CONSTRUCTION";
                }
                ...
                if (colony.Shipyard.BuildQueue.Count > 0) { goto ProcessQueue; }
                ...
                if (potentialProjects.Count == 1) // build the only existing option
                    {
                        ...
                        BuildShipType(colony, _civM, ShipType.Medical, potentialProjects[0]);
                    ...
                    if (_shipOrderIsDone == false)
                    {
                        switch (_neededShipTypeText)
                        {
                            case "COLONY":
                                _neededShipType = ShipType.Colony;
                                CheckFor_BuildShip(colony, _civM, ShipType.Colony, _proj);
                                break;
                            case "CONSTRUCTION":
                                _neededShipType = ShipType.Construction;
                                CheckFor_BuildShip(colony, _civM, ShipType.Construction, _proj);
                                break;
                            case "MEDICAL":
                                _neededShipType = ShipType.Medical;
                                CheckFor_BuildShip(colony, _civM, ShipType.Medical, _proj);
                                break;
                            case "TRANSPORT":
                                _neededShipType = ShipType.Transport;
                                CheckFor_BuildShip(colony, _civM, ShipType.Transport, _proj);
                                break;
                            case "SPY":
                                _neededShipType = ShipType.Spy;
                                CheckFor_BuildShip(colony, _civM, ShipType.Spy, _proj);
                                break;
                            case "DIPLOMATIC":
                                _neededShipType = ShipType.Science;
                                CheckFor_BuildShip(colony, _civM, ShipType.Science, _proj);
                                break;
                            case "SCIENCE":
                                _neededShipType = ShipType.Science;
                                CheckFor_BuildShip(colony, _civM, ShipType.Science, _proj);
                            ...
                            case "SCOUT":
                                _neededShipType = ShipType.Scout;
                                CheckFor_BuildShip(colony, _civM, ShipType.Scout, _proj);
                                break;
                            case "FASTATTACK":
                                _neededShipType = ShipType.FastAttack;
                                CheckFor_BuildShip(colony, _civM, ShipType.FastAttack, _proj);
                                break;
                            case "CRUISER":
                                _neededShipType = ShipType.Cruiser;
                                CheckFor_BuildShip(colony, _civM, ShipType.Cruiser, _proj);
                                break;
                            case "HEAVYCRUISER":
                                _neededShipType = ShipType.HeavyCruiser;
                                CheckFor_BuildShip(colony, _civM, ShipType.HeavyCruiser, _proj);
                                break;
                            case "STRIKECRUISER":
                                _neededShipType = ShipType.StrikeCruiser;
                                CheckFor_BuildShip(colony, _civM, ShipType.StrikeCruiser, _proj);
                                break;
                            case "COMMAND":
                                _neededShipType = ShipType.Command;
                                CheckFor_BuildShip(colony, _civM, ShipType.Command, _proj);
                                break;
                        }
                    }
                    ...
                    //        CheckFor_BuildShip(colony, _civM, ShipType.Cruiser, _proj); // includes Heavy and StrikeCruiser
                    ...
                    //    CheckFor_BuildShip(colony, _civM, ShipType.Diplomatic, _proj);
                    ...
                    //    CheckFor_ColonyShip(colony, _civM, ShipType.Colony, _proj);
                    //}



                    // colony ships done above or better in > CheckFor_ColonyShip
                    ...
                    //    {
                    //        BuildShipType(colony, _civM, ShipType.Command, _proj);
                    //    }
                    ...
                    //        if (_proj.TurnsRemaining < 10)
                    //        {
                    //            BuildShipType(colony, _civM, ShipType.HeavyCruiser, _proj);
                    //        }
                    //        //_listPrioShipBuild2.Add(ShipType.Command); 
                    //        _shipOrderIsDone = true;
                    //    }
                    ...
                    //        if (_proj.TurnsRemaining < 10)
                    //        {
                    //            BuildShipType(colony, _civM, ShipType.StrikeCruiser, _proj);
                    //        }
                    //        //_listPrioShipBuild2.Add(ShipType.Command); 
                    //        //_shipOrderIsDone = true;
                    //    }
                    ...
                    //        if (_proj.TurnsRemaining < 10)
                    //        {
                    //            BuildShipType(colony, _civM, ShipType.Cruiser, _proj);
                    //        }
                    //        //_listPrioShipBuild2.Add(ShipType.Command); 
                    //        _shipOrderIsDone = true;
                    //    }
                    ...
                    //    if (_proj.TurnsRemaining < 10)
                    //    {
                    //        BuildShipType(colony, _civM, ShipType.FastAttack, _proj);
                    //    }
                    //    //_listPrioShipBuild2.Add(ShipType.Command); 
                    //    _shipOrderIsDone = true;
                    //}
                    ...
                    //    if (_proj.TurnsRemaining < 10)
                    //    {
                    //        BuildShipType(colony, _civM, ShipType.Scout, _proj);
                    //    }
                    //    //_listPrioShipBuild2.Add(ShipType.Command); 
                    //    _shipOrderIsDone = true;
                    //}
                    ...
                    //if (_shipTypeToBuild == null || PlayerAI.IsInFinancialTrouble_BelowMinus2000(colony.Owner))
                    //{
                    //    goto ProcessQueue;
                    //    //nothing;  > _shipTypeToBuild is never "!= null"
                    //}
                    //else
                    //{
                    //    BuildShipType(colony, _civM, _shipTypeToBuild, _proj);  // _proj is relevant here !!!
                    //}
                    ...
                    //    BuildShipType(_colony, _civM, needed_ShipType_1, project);
                    //    if (_shipcolonyNeeded > 2) 
                    //    { 
                    //        needed_ShipType_2 = ShipType.Colony; 
                    //        BuildShipType(_colony, _civM, needed_ShipType_2, project);
                    //        goto ProcessQueue;
                    //    }
                    //}
                    ...
                    //BuildShipType(_colony, _civM, needed_ShipType_1, project); needed_1_done = true;
                    //BuildShipType(_colony, _civM, needed_ShipType_2, project); needed_2_done = true;
                    ...
                    //    int _shipMedicalNeeded = _civM.Z_Ship_Medical_Needed - _civM.Z_Ship_Medical_Available - _civM.Z_ShipMedicalOrdered;
                    //    if(_shipMedicalNeeded > 0) BuildShipType(_colony, _civM, ShipType.Medical, project);
                    //}
                    ...
                    //    if (_ShipSpyNeeded > 0) BuildShipType(_colony, _civM, ShipType.Spy, project);
                    //}
                    ...
                    //if (!shipDesigns.Where(o => o.ShipType == ShipType.Scout).Any(_colony.Shipyard.IsBuilding))
                    //{
                    //    for (int i = fleets.Count(o => o.IsScout); i < NOT_USED_NumScouts; i++)
                    //    {
                    ...
                    BuildProject newProject = potentialProjects.LastOrDefault(p => shipDesigns.Any(d => d.ShipType == _neededShipType && p.BuildDesign == d));
                        if (newProject != null && colony.Shipyard.BuildQueue.Count < 1)
                        {
        ...
        private static void CheckFor_ColonyShip(Colony colony, CivilizationManager _civM, ShipType shipType, BuildProject project)
        {
            string _newline = Environment.NewLine;
            string _text;
            bool boolCheckShipProduction = true;
            ...
            //CheckFor_SystemsToColonizeProject(colony);

            //int _shipcolonyNeeded = _civM.Z_Ship_Colony_Needed - _civM.Z_Ship_Colony_Available - _civM.Z_Ship_Colony_Ordered;
            if (_civM.Z_Ship_Colony_Needed > 0)
            {
                needed_ShipType_1 = ShipType.Colony;
                BuildShipType(colony, _civM, needed_ShipType_1, project);
                if (_civM.Z_Ship_Colony_Needed > 2)
                {
                    needed_ShipType_2 = ShipType.Colony;
                    BuildShipType(colony, _civM, needed_ShipType_2, project);
                    //goto ProcessQueue;
                }
            }
        ...
        private static void CheckFor_BuildShip(Colony colony, CivilizationManager _civM, ShipType shipType, BuildProject project)
        {
            string _newline = Environment.NewLine;
            string _text;
            ...
            if (project.TurnsRemaining < 10)
            {


                BuildShipType(colony, _civM, shipType, project); //needed_1_done = true;
...
#pragma warning restore IDE0079 // Remove unnecessary suppression

        {
            ...
            if (colony.Sector == homeSector)
            {
                ...
                // Military
                Fleet defenseFleet = homeSector.GetOwnedFleets(civ).FirstOrDefault(o => o.AITypeUnit == UnitAIType.SystemDefense);
                if ((defenseFleet?.HasCommandShip != true) &&
                    homeFleets.All(o => !o.HasCommandShip) &&
        ...
        //private static void CheckFor_SystemsToColonizeProject(Colony colony)
        //{
        //    CivilizationManager _civM = GameContext.Current.CivilizationManagers[colony.Owner.CivID];
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
        {
            ...
            //var fleets = GameContext.Current.Universe.FindOwned<Fleet>(_civ);
