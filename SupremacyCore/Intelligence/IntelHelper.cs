...
namespace Supremacy.Intelligence
{
    public static class IntelHelper
    {
        ...
        public static CivilizationManager GetSpiedCivilization(Civilization localPlayer)
        {
            ...
            foreach (var aCivManager in empires)
            {
                ...
                if (aCivManager.CivilizationID < 7 && aCivManager.CivilizationID != localPlayer.CivID)
                {
        ...
        //public static List<CombatAssets> GetCombatAssets(MapLocation location) //ToDo Get Spied Colonies?
        //{
        ...
        //public static List<CombatAssets> GetCamouflageAssets(MapLocation location) //To Do, do we need camouflage on our spy ships;
        //{
        //    var assets = new Dictionary<Civilization, CombatAssets>();
        //    var results = new List<CombatAssets>();
        //    //var units = new Dictionary<Civilization, CombatUnit>();
        ...
        //public static CombatOrders GenerateBlanketOrders(CombatAssets assets, CombatOrder order) // To Do spy ship ordres??
        //{
