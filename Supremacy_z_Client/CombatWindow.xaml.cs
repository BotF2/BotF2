...
namespace Supremacy.Client
{
    ...
    public partial class CombatWindow
    {
        ...
        private List<Civilization> _friendlyCivs; 
        // players civ and fight along side civs if any    
        ...
        private void HandleCombatUpdate(CombatUpdate update)
        {
            ...
            if (update.CombatUpdate_IsCombatOver)  // Combat is over
            {
                ...
                if (_update.IsStandoff)
                {
                    ...
                    //CivilizationManager _player_civM = GameContext.Current.CivilizationManagers[_appContext.LocalPlayer.CivID];
                    _player_civM.SitRepEntries.Add(new ReportEntry_CoS(_player_civM.Civilization, _update.Sector.Location, _text_combatWindow, "", "", SitRepPriority.Red));

                    //_player_civM.SitRepEntries.Add(new CombatSummarySitRepEntry(_player_civM.Civilization, _update.Sector.Location,
