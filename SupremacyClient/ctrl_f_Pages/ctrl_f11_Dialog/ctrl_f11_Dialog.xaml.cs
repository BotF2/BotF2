...
namespace Supremacy.Client
{
    ...
    /// </summary>
    public partial class CTRL_F11_Dialog
    {
        public CTRL_F11_Dialog()
        {
            InitializeComponent();
            ...
            GameLog.Client.UIDetails.DebugFormat("CTRL_F11-Dialog initialized");
        }
